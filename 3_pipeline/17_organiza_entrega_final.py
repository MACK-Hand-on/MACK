...
if not (CLONE / ".git").is_dir():
    ...
    DOCS_GIT = [
        "LEIA-ME_Entrega_Final.md", "Kenzie360_LEIA-ME_Entrega_Final.pdf",
        "Item3_Governanca.md", "Kenzie360_Governanca.pdf",
        "Item5_Trilhas_de_Carreira.md", "Kenzie360_Trilhas_de_Carreira.pdf",
        "Features_e_Vazamento.md", "Kenzie360_Features_e_Vazamento.pdf",
        "Horas_Lote_Novo.md", "Kenzie360_Horas_Lote_Novo.pdf",
        "Guia_Painel_Modelo_Gi.md", "Guia_Grafico_Monitoramento_Gi.md",
        "Kenzie360_Apresentacao.pptx", "Kenzie360_Apresentacao.pdf",
    ]
